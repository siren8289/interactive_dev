...
export default function BouncyBalls() {
  ...
  useEffect(() => {
    ...
    const draw3DBall = (x, y, r) => {
      ...
      gradient.addColorStop(0.2, "#d9ffe0"); // 밝은 민트
      gradient.addColorStop(0.6, "#4cd38a"); // 중간 톤
      gradient.addColorStop(1, "#007a3e"); // 진한 그린
    ...
    const renderLoop = () => {
      ...
      ctx.fillStyle = "#f2fff5"; // 배경 연한 그린 톤
